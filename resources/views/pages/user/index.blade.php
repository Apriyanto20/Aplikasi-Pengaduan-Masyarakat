                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="icon-box">
                            ...
                            <p class="description">Pelayanan selama 24 jam, sampaikan aduan anda kapan saja, dimana saja
                                dan jam
                                berapa saja.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mt-4 mt-md-0">
                        <div class="icon-box">
                            ...
                            <p class="description">Setiap data Identitas pengaduan yang dilakukan oleh masyarakat kami
                                lindungi secara
                                aman </p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mt-4 mt-lg-0">
                        <div class="icon-box">
                            ...
                            <p class="description">Penanganan pengaduan yang di sampaikan, akan kami proses secara cepat
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-4 pt-4 pt-lg-0">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="/pengaduanku" method="post">
                                    @csrf
                                    ...
                                    <button type="submit" class="btn btn-success btn-md mt-3 d-flex"><i
                                            class="icon bi bi-lock"></i> Login</button>
                                </form>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <form action="/" method="post">
                                    ...
                                    <div class="form form-group">
                                        ...
                                        <input type="text" name="textNik" class="form form-control"
                                            placeholder="contoh : 3201234556777">
                                    </div>
                                    <div class="form form-group mt-3">
                                        <label for="textNama">Nama</label>
                                        <input type="text" name="textNama" class="form form-control"
                                    ...
                                    <div class="form form-group">
                                        ...
                                        <input type="text" name="textAlamat" class="form form-control"
                                    ...
                                    <button type="submit" class="btn btn-success btn-md mt-4 btn-block"><i
                                            class="bi bi-card-checklist"></i> Register</button>
                                    <!-- </div> -->
                            </div>
                            </form>
                        </div>
